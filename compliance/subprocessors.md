...
| **Vercel** | Hosting / CDN (request metadata, IP — **not** the health data; app calls Supabase browser-side) | https://vercel.com/legal/dpa | ✅ **In force (Pro plan, Jun 25 2026)** — DPA auto-applies to Pro/Enterprise by using the service ("deemed signed by entering into the Agreement"); PDF on file. Nothing to sign. |
